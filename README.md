...
http://stargram.herokuapp.com/

### *Space Photo viewing app for the star enthusiast*
...
This app was built using the latest and greatest technologies out today. I got this idea from an youtube and chose to build a clone of of it in React becuase *Instagram* uses **React** which is a photo sharing app with impeccable load times. I chose to use **Redux** as my single state handler becasue of its overall clean and  effective way of handling the state of the application especially for scaling it larger. I thought using **Webpack**. It takes away the layer that other task runners like Gulp and Grunt add to projects. I didn't build out the server file till I needed to launch it on **Heroku** . I went with a simple **Node** server with **Hapi** because, why not learn a ***new*** framework for this challenge? :) . I deployed it on Heroku for your viewing pleasure. 
